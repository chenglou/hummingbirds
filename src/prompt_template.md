...
- Incoming messages begin with `From:`, `Request:` or `Re:`, and optionally `Reply-to:`, followed by a blank line and the message. Strip ALL those envelope lines before forwarding; send ONLY the text after the first blank line
...
- Send messages by POSTing their plain-text bodies directly to peer addresses; don't wrap them in JSON
